...
namespace Transparent_Form
{
    public partial class ManageStudentForm : Form
    {
            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    ...
                    if (result != null && result.success)
                    {
                        ...
                        if (DataGridView_student.Columns["classId"] != null)
                            DataGridView_student.Columns["classId"].Visible = false;

                        if (DataGridView_student.Columns["classArmId"] != null)
                            DataGridView_student.Columns["classArmId"].Visible = false;
                        ...
                        DataGridView_student.MultiSelect = false;
                    }
                    else
                    {
        ...
        private async void DataGridView_student_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (DataGridView_student.CurrentRow != null)
            {
                ...
                if (DataGridView_student.CurrentRow.Cells["classId"]?.Value != null)
                {
                    comboBox_class.SelectedValue = Convert.ToInt32(DataGridView_student.CurrentRow.Cells["classId"].Value);

                    await LoadClassArmsByClass(Convert.ToInt32(DataGridView_student.CurrentRow.Cells["classId"].Value));

                    if (DataGridView_student.CurrentRow.Cells["classArmId"]?.Value != null)
                    {
                        comboBox_classArm.SelectedValue = Convert.ToInt32(DataGridView_student.CurrentRow.Cells["classArmId"].Value);
                    }
                }
            }
        }
